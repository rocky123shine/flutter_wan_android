class TreeEntity {
  ...
  TreeEntity.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <TreeData>[];(json['data'] as List).forEach((v) { data!.add(TreeData.fromJson(v)); });
    }
...
class TreeData {
  ...
  TreeData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['children'] != null) {
      children = <TreeDatachild>[];for (var v in (json['children'] as List)) { children!.add(TreeDatachild.fromJson(v)); }
    }
    name = json['name'];
