class ProjectListEntity {
  ...
  ProjectListEntity.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? ProjectListData.fromJson(json['data']) : null;
...
class ProjectListData {
  ...
  ProjectListData.fromJson(Map<String, dynamic> json) {
    ...
    size = json['size'];
    if (json['datas'] != null) {
      datas = <ProjectListDataData>[];
      for (var v in (json['datas'] as List)) {
        datas!.add(ProjectListDataData.fromJson(v));
      }
    }
  }
...
class ProjectListDataData {
  ...
  ProjectListDataData.fromJson(Map<String, dynamic> json) {
    ...
    userId = json['userId'];
    if (json['tags'] != null) {
      tags = <ProjectListDataDatasTag>[];
      for (var v in (json['tags'] as List)) {
        tags?.add(ProjectListDataDatasTag.fromJson(v));
      }
    }
